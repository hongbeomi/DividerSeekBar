...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| <img src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/text_bottom.png" width="100%"/> | <img src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/text_top.png" width="100%"/> |
...
| :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| <image src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/target_mode.gif" width="100%"/> | <image src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/minimum_mode.gif" width="100%"/> | <image src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/maximum_mode.gif" width="100%"/> |

</br>

### onProgressEnabled, onProgressDisabled

<img src="https://github.com/hongbeomi/DividerSeekBar/blob/master/demo/listener_divider_seek_bar.gif" align="right" width="32%"/> We can hear DividerSeekBar when it is active and when it is not active, and we can listen it using the listener. 
